...
INSERT INTO `registered_user` (`id`, `first_name`, `last_name`, `email_address`, `password`, `address`, `credit_card`, `annual_fee_expiry_date`) VALUES
('ccd13222-f4d9-495e-8f19-80f24c46baaa', 'Admin', 'admin', 'admin@gmail.com', '$2b$10$6SPu0zgXx7NdVrg93nFDAeS/szXiRJQaRQsCwWRAdVyAynKYow6Za', 'Admin Adress', '1111 2222 3333 4444', NULL);
...
VALUES
('M_001','Orfã: A origem', false),
('M_002','Não se preocupre, querida', false),
('M_003','O telefone preto', false),
('M_004','A mulher Rei', false),
('M_005','Avatar', false),
('M_006','Sorria', false),
('M_007','A queda', false);
...
VALUES
  ...
  ('ST_007', 'T_004', 'M_006', '2022-12-11 09:00:00'),
  ('ST_008', 'T_002', 'M_007', '2022-12-11 09:00:00');
